...
class BasePredictor:
    ...
    def stream_inference(self, source=None, model=None, *args, **kwargs):
        ...
        with self._lock:  # for thread-safe inference
            ...
            edge_coordinates = get_image_edges_coordinates("test1.jpg")
            normalized_coordinates = normalize_coordinates(edge_coordinates)
            keypoints = [(316,38),(319,102),(73,91),(170,111),(263,127),
                         (391,131),(467,131),(572,130),(319,195),(329,305),
                         (285,362),(164,432),(168,576),(372,356),(464,478),(539,585)]
            ...
            for batch in self.dataset:
                ...
                # Postprocess
                im1s = im0s.copy()
                im1s[0] = draw_red_marks_and_green_keypoints_on_frame(im0s[0], normalized_coordinates, keypoints) #arg:circle_keypoints

                frame_gauge = (nose() + lefteye() + righteye() + leftear() 
                               + leftshoulder() + rightshoulder() + leftelbow() 
                               + rightelbow() + leftwrist() + rightwrist() 
                               + lefthip() + righthip() + leftknee() + rightknee() 
                               + leftankle() + rightankle()) / 17 * 100

                im1s[0] = print_progress_bar(im1s[0], frame_gauge, 100)
